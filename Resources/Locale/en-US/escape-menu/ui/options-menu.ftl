...
ui-options-faction-music = Faction & Station Music
ui-options-faction-music-tooltip = Faction combat tracks and station themes. When off, the generic combat music and the area's own music play instead.
